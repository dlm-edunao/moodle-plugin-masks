...
require_once($CFG->dirroot . '/mod/masks/backup/moodle2/backup_masks_settingslib.php');

/**
 * Provides the steps to perform one complete backup of the MASKS instance
 */
class backup_masks_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the masks.xml file
     */
